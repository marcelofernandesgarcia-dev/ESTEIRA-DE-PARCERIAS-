...
## 7. Estrutura de Pastas `/landing_transferegov/`

```
/landing_transferegov/
├── index.html
├── README.md
├── /css/
│   └── style.css
...
- **/midia/** — Recursos visuais (imagens, ícones, diagramas) separados por tipo para facilitar a montagem.
...
- **/materiais_complementares/** — Pasta específica para armazenamento dos arquivos finais de mídias de apoio, incluindo apresentações (.pptx), áudios e podcasts (.mp3/.wav), vídeos (.mp4) e relatórios e análises conceituais (.pdf/.docx).
...
|---|---|---|---|
| 2.1.0 | 19/08/2026 | Atualização com pasta de materiais complementares e modularização JS | Antigravity |
